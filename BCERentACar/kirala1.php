        ...
        <section id="features" class="section-area">
            ...
            <div class="features-body">
                <div class="container">
                    ...
                    $db=new \database();
                        $myQuery=$db->TableOperations("SELECT * FROM arac LIMIT 0,4");
                        ...
                        foreach($myQuery as $items)
                        {
                            ...
                            <div class="col3">
                                    ...
                                    <input type="hidden" name="plaka" value="<?php echo $items['Plaka']; ?>">
                                    <input type="hidden" name="kullanici_eposta" value="<?php echo $_SESSION['Kullanici_EPosta']; ?>">
                                    <div class="item">
                                        <div class="zoom">
                                        ...
                                        <div class="item-text">
                                            ...
                                            ?>
                                            <button class="inpbutton" type="submit" name="kirala">Kirala</button>
                                        </div>
                                    </div>
        ...
        <section id="features" class="section-area">
            <div class="features-body">
                <div class="container">
                    ...
                    $db=new \database();
                        $myQuery=$db->TableOperations("SELECT * FROM arac LIMIT 4,4");
                            ...
                            <div class="col3">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="item-text">
                                            ...
                                            echo $items["Plaka"] . "<br><br>" . $items["Marka"] . " " . $items["Model"] . "<br>" . $items["AracTipi"] . "<br><br>";
                                            ?>
                                            <button class="inpbutton" type="submit" value="<?php echo $items['Plaka']; ?>" name="kirala">Kirala</button>
                                        </div>
                                    </div>
                        ...
                        <tbody>
                            ...
                            <td class="nv">
                                ...
                                <a>
                                    ...
                                    <li2><a class="navi" href="kirala2.php">></a></li2>
                                </a>
                            </tr>
                        </tbody>
                    </table>
